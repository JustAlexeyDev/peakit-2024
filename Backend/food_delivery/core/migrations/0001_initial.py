    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorite_products', models.ManyToManyField(related_name='favorited_by', to='core.product')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.AddField(
            model_name='cart',
            name='order_history',
            field=models.ManyToManyField(related_name='orders', through='core.Order', to='core.product'),
        ),
    ]
